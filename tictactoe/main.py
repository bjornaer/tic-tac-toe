...
class Main_Screen(Screen):
    ...
    def clear_screen(self):
        ...
        Clock.schedule_once(partial(self.clear_opacity, self.x_2), 0.15)
        Clock.schedule_once(partial(self.clear_opacity, self.o_2), 0.15)
        Clock.schedule_once(partial(self.clear_opacity, self.x_3), 0.3)
        Clock.schedule_once(partial(self.clear_opacity, self.o_3), 0.3)
        Clock.schedule_once(partial(self.clear_opacity, self.x_4), 0.45)
        Clock.schedule_once(partial(self.clear_opacity, self.o_4), 0.45)
        Clock.schedule_once(partial(self.clear_opacity, self.x_5), 0.6)
        Clock.schedule_once(partial(self.clear_opacity, self.o_5), 0.6)
        Clock.schedule_once(partial(self.clear_opacity, self.x_6), 0.75)
        Clock.schedule_once(partial(self.clear_opacity, self.o_6), 0.75)
        Clock.schedule_once(partial(self.clear_opacity, self.x_7), 0.90)
        Clock.schedule_once(partial(self.clear_opacity, self.o_7), 0.90)
        Clock.schedule_once(partial(self.clear_opacity, self.x_8), 1.05)
        Clock.schedule_once(partial(self.clear_opacity, self.o_8), 1.05)
